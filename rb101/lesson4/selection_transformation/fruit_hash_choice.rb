=begin
Launch School: RB101 Programming Foundations - Lesson 4 - selection_transformation
...
# def select_fruit(produce, produce_choice)
#   selected_collection = {}
#   counter = 0
...
#     selected_collection[selected_key[counter]] = selected_value if selected_value == produce_choice
#     counter += 1
#   end
...
# puts("Pick one: Fruit or Vegetable")
# produce_choice = gets.chomp

# p select_fruit(produce, produce_choice) # => {"apple"=>"Fruit", "pear"=>"Fruit"}

# require 'pry'

# # Mutating
puts("Mutating - returns same hash")
def select_fruit!(produce2, produce_choice)
  # selected_collection = {}
  counter = 0
  ...
  loop do
    ...
    if produce2[produce_keys_arr[counter]] == produce_choice then
...
puts("Pick one: Fruit or Vegetable")
produce_choice = gets.chomp
p select_fruit!(produce2, produce_choice) # => {"apple"=>"Fruit", "pear"=>"Fruit"}
